...
import logoImg from "@/assets/tow-truck.png";
...
// Galeria: usando imagem local disponível no projeto
const guincho1 = { url: towTruckBg };
const guincho2 = { url: towTruckBg };
const guincho3 = { url: towTruckBg };
